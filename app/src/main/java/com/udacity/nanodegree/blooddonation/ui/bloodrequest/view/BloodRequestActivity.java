...
public class BloodRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityBloodRequestBinding = DataBindingUtil.setContentView(this, R.layout.activity_blood_request);
    ...
    private void initSpinner() {
        ArrayAdapter<CharSequence> bloodGroupAdapter = ArrayAdapter.createFromResource(this, R.array.blood_group,
                android.R.layout.simple_spinner_item);
        bloodGroupAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mActivityBloodRequestBinding.bloodGroupDropDown.setAdapter(bloodGroupAdapter);

        ArrayAdapter<CharSequence> requestAdapter = ArrayAdapter.createFromResource(this, R.array.blood_request,
                android.R.layout.simple_spinner_item);
