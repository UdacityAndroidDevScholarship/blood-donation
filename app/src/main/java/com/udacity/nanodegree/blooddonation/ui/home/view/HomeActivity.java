...
public class HomeActivity extends BaseActivity
  ...
  @Override public void setSearchCircle(@NonNull LatLng latLng) {
  ...
  @Override public void putGeoKeyMarker(String key, GeoLocation location) {
  ...
  @Override public void removeOldGeoMarker(String key) {
  ...
  @Override public void animateGeoMarker(String key, GeoLocation location) {
    Marker marker = this.markers.get(key);
    if (marker != null) {
  ...
  @Override public void showGeoQueryErrorDialogBox(DatabaseError error) {
